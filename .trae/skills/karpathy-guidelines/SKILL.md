...
description: 用于减少常见 LLM 编码错误的行为准则。在编写、审查或重构代码时使用，可避免过度复杂化、进行外科手术式修改、显式暴露假设，并定义可验证的成功标准。
---

# Karpathy 指南

用于减少常见 LLM 编码错误的行为准则，来源于 `https://x.com/karpathy/status/2015883857489522876` 。
